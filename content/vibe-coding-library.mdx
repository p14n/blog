---
title: Vibe-coding the library I wanted to see (in Java)
date: 2025-05-08
image: ./vibe.gif
---
...
The library publishes and consumes strictly ordered events on Postgres, using [Debezium](https://debezium.io/) for change data capture and notification.
